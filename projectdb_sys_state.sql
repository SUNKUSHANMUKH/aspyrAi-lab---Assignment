...
CREATE TABLE `sys_state` (
  `Stt_ID` int NOT NULL,
  `Stt_Name` varchar(50) DEFAULT NULL,
  `Stt_Code` varchar(50) DEFAULT NULL,
  PRIMARY KEY (`Stt_ID`)
...
INSERT INTO `sys_state` VALUES (1,'California','CA'),(2,'Texas','TX'),(3,'New York','NY');
...
-- Dump completed on 2024-10-09 18:13:58
